...
```{r}
esModel <- nhlBuild(esData[, -1], type = "gbm", perc = 0.7, seed = 98765)
```
...
```{r, cache=TRUE, results='hide'}
shgbmmod1 <- nhlBuild(data = gbmdata, type = "gbm", perc = 0.7, seed = 9112)
shgbmmod2 <- nhlBuild(data = gbmdata, type = "gbm", perc = 0.7, seed = 2857)
shgbmmod3 <- nhlBuild(data = gbmdata, type = "gbm", perc = 0.7, seed = 31415)
shgbmmod4 <- nhlBuild(data = gbmdata, type = "gbm", perc = 0.7, seed = 28182)
```
...
shgbmmod1 <- nhlBuild(shDataGBM1[, -1], type = "gbm", perc = 1)
shgbmmod2 <- nhlBuild(shDataGBM2[, -1], type = "gbm", perc = 1)
shgbmmod3 <- nhlBuild(shDataGBM3[, -1], type = "gbm", perc = 1)
shgbmmod4 <- nhlBuild(shDataGBM4[, -1], type = "gbm", perc = 1)
```
...
```{r}
shModel <- nhlBuild(shData[, -1], type = "gbm", perc = 0.7, seed = 98765)
```
...
```{r, cache=TRUE, results='hide'}
ppgbmmod1 <- nhlBuild(data = gbmdata, type = "gbm", perc = 0.7, seed = 9112)
ppgbmmod2 <- nhlBuild(data = gbmdata, type = "gbm", perc = 0.7, seed = 2857)
ppgbmmod3 <- nhlBuild(data = gbmdata, type = "gbm", perc = 0.7, seed = 31415)
ppgbmmod4 <- nhlBuild(data = gbmdata, type = "gbm", perc = 0.7, seed = 28182)
```
...
ppgbmmod1 <- nhlBuild(ppDataGBM1[, -1], type = "gbm", perc = 1)
ppgbmmod2 <- nhlBuild(ppDataGBM2[, -1], type = "gbm", perc = 1)
ppgbmmod3 <- nhlBuild(ppDataGBM3[, -1], type = "gbm", perc = 1)
ppgbmmod4 <- nhlBuild(ppDataGBM4[, -1], type = "gbm", perc = 1)
ppgbmmod5 <- nhlBuild(ppDataGBM5[, -1], type = "gbm", perc = 1)
ppgbmmod6 <- nhlBuild(ppDataGBM6[, -1], type = "gbm", perc = 1)
```
...
```{r}
ppModel <- nhlBuild(ppData[, -1], type = "gbm", perc = 0.7, seed = 98765)
```
