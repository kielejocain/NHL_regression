...
# estModel <- nhlModel(2013, 2013, outcome = 38, cols = cols, methods = c("rf", "gbm", "pls", "knn", "svmLinear"),
#                      controls = controls, seed = 490250)
# estCorrs <- nhlCorr(2010, 2013, 38, estModel)
# estModel2 <- nhlModel(2013, 2013, outcome = 38, cols = cols, methods = c("pls", "knn", "svmLinear"),
#                       controls = controls, seed = 331791)
# estCorrs2 <- nhlCorr(2010, 2013, 38, estModel2)
estModel3 <- nhlModel(2013, 2013, outcome = 38, cols = cols, methods = c("rf", "pls", "knn", "svmLinear"),
                      controls = controls, seed = 810097)
...
preds2013$mean <- rowSums(preds2013[, 2:5]) / 4
preds2014$mean <- rowSums(preds2014[, 2:5]) / 4
...
grid.arrange(plot14naive, plot14rf, plot14pls, plot14knn, plot14svm, plot14cum, ncol = 2)
dev.off()
...
grid.arrange(plot13naive, plot13rf, plot13pls, plot13knn, plot13svm, plot13cum, ncol = 2)
dev.off()
...
shtFactors <- nhlAnalyze(fitData, fitData, seed = 66951)
shtFactors

## model building
cols = c(1:2, 27, 29, 38:41)
# shtModel <- nhlModel(2013, 2013, outcome = 39, cols = cols, methods = c("rf", "gbm", "pls", "knn", "svmLinear"),
#                      controls = controls, seed = 756846)
# shtCorrs <- nhlCorr(2010, 2013, 39, shtModel)
# shtModel2 <- nhlModel(2013, 2013, outcome = 39, cols = cols, methods = c("rf", "gbm", "pls", "svmLinear"),
#                      controls = controls, seed = 636404)
# shtCorrs2 <- nhlCorr(2010, 2013, 39, shtModel2)
shtModel3 <- nhlModel(2010, 2010, outcome = 39, cols = cols, methods = c("rf", "gbm", "pls", "svmLinear"),
...
pptFactors <- nhlAnalyze(fitData, fitData, seed = 779315)
pptFactors

## model building
cols = c(1:2, 6, 10, 24:25, 38:41)
